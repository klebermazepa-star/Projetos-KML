...
*******************************************************************************/
{include/i-prgvrs.i RE0405 2.00.00.006 } /*** 010006 ***/

&IF "{&EMSFND_VERSION}" >= "1.00"
&THEN
{include/i-license-manager.i RE0405 MRE}
&ENDIF
...
bt-config-impr c-arquivo rs-execucao tb-imprimir-parametro 
...
DEFINE VARIABLE da-data-f AS DATE FORMAT "99/99/9999":U INITIAL 12/31/9999 
     VIEW-AS FILL-IN 
     SIZE 13 BY .88 NO-UNDO.

DEFINE VARIABLE da-data-i AS DATE FORMAT "99/99/9999":U INITIAL 01/01/001 
     LABEL "Data" 
     VIEW-AS FILL-IN 
     SIZE 13 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     ...
     c-estab-ini AT ROW 3.46 COL 19.86 COLON-ALIGNED
     c-estab-fim AT ROW 3.46 COL 45 COLON-ALIGNED NO-LABEL
     IMAGE-1 AT ROW 2 COL 35
     IMAGE-2 AT ROW 2 COL 44
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Integra‡Æo com Obriga‡äes Fiscais"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF C-Win /* Integra‡Æo com Obriga‡äes Fiscais */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Integra‡Æo com Obriga‡äes Fiscais */
DO:
...
{utp/ut9000.i "RE0405" "2.00.00.003"}
...
do  on error undo, return error
    ...
    {include/i-rprun.i rep/re0405rp.p}
